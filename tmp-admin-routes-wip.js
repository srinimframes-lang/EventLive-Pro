...
router.get('/storage/r2', getR2StorageStatus);
...
// Real-time alerts (platform Super Admin)
router.get('/alerts/settings', authorizePlatformAdmin, getAlertSettings);
router.patch('/alerts/settings', authorizePlatformAdmin, updateAlertSettings);
router.get('/alerts/history', authorizePlatformAdmin, getAlertHistory);
router.post('/alerts/test', authorizePlatformAdmin, postTestAlert);
router.post('/alerts/:id/retry', authorizePlatformAdmin, postRetryAlert);
