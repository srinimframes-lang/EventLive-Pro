...
export const env = {
  ...
  // Razorpay (optional). When key id + secret are set, credit Checkout is enabled.
  // Use Test Mode keys first. Never expose key_secret or webhook_secret to the client.
  razorpay: {
