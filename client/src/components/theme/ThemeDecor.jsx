...
export default function ThemeDecor({ iconSet = 'rings', decoration = 'elegant' }) {
  ...
  if (isMinimal) {
    return (
      <div className="theme-decor-minimal pointer-events-none absolute inset-0 z-0" aria-hidden>
  ...
  return (
    <div className="theme-decor pointer-events-none absolute inset-0 z-0" aria-hidden>
      <span
